 ...
 * em contra-rolagem e o selo roxo no meio). Substituído pelo layout
 * editorial em `problem-solution.tsx`, mas mantido inteiro e funcional.
 *
 * Para voltar a ele, troque em `src/app/page.tsx`:
 *   import { ProblemSolution } from "@/components/marketing/problem-solution";
 * por:
 *   import { ProblemSolution } from "@/components/marketing/problem-solution-vs";
 *
 * Depende de `vs-scroller.tsx` e das classes `.vs-*` do `globals.css`.
 */
import type { Round } from "@/components/marketing/vs-scroller";
import { VsScroller } from "@/components/marketing/vs-scroller";
 ...
 *  controlada — travar um palco de tela cheia em 360px é hostil. */
