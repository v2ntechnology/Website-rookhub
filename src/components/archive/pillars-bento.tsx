 ...
 * interativas em `marketing/pillars.tsx`, mas mantido inteiro e funcional.
 *
 * Para voltar a ele, troque em `src/app/(marketing)/page.tsx`:
 *   import { Pillars } from "@/components/marketing/pillars";
 * por:
 *   import { Pillars } from "@/components/archive/pillars-bento";
 *
    ...
    <Section id="pilares" className="surface-deep border-b-0">
      <Container>
        ...
        {/* Baralho: a partir de lg cada painel gruda logo abaixo da barra e
            ...
            uma pilha normal, porque travar painel alto em tela pequena é hostil. */}
